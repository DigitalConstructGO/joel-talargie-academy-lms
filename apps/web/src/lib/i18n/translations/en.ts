export const en = {
  ...
  // Hero Section
  'hero.badge': 'Learn with Purpose. Build with Confidence.',
  'hero.title1': 'Master High-Demand',
  'hero.title2': 'Tech & AI Skills',
  'hero.subtitle':
    'Explore hands-on, practical courses built for the next generation of African tech talent, creators, and innovators.',
  'hero.ctaBrowse': 'Explore Courses',
  'hero.ctaStart': 'Get Started Free',

  // Value Pills / Highlights
  'value.selfPaced': 'Self-Paced Learning',
  'value.practical': 'Real-World Projects',
  'value.certified': 'Verified Certificates',

  // Section Headers
  'featured.title': 'Featured Courses',
  'featured.subtitle': 'Hand-picked flagship courses taught by industry leaders.',
  'featured.browseAll': 'Browse all courses',
  'featured.empty': 'No featured courses available right now.',

  'categories.title': 'Explore Categories',
  'categories.subtitle': 'Find courses aligned with your passion and career goals.',
  ...
  'mentor.viewProfile': 'Instructor Profile',
  ...
  'sidebar.browseCourses': 'Browse Catalog',
