    ...
    <ContentContainer>
          ...
          <Reveal delaySeconds={0.05}>
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>
                  {locale === 'am'
                    ? 'የእውቂያ ዝርዝሮችዎን እና የተማሪ መገለጫዎን ያዘምኑ።'
              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <form className="space-y-4" onSubmit={profileForm.handleSubmit(onProfileSubmit)}>
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="bio">{locale === 'am' ? 'ስለ እኔ' : 'Biography'}</Label>
                      <Textarea
                        id="bio"
                        rows={4}
                        ...
                        placeholder={
                          locale === 'am'
                            ? 'ስለ ራስዎ ጥቂት መረጃ እዚህ ይጻፉ...'
                            : 'Tell instructors and fellow learners a bit about your background...'
                        }
                      />
          ...
          <Reveal delaySeconds={0.09}>
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>
                  {locale === 'am'
                    ? 'ጠንካራ የይለፍ ቃል በመጠቀም መለያዎን ደህንነቱ የተጠበቀ ያድርጉ።'
      ...
      <Reveal delaySeconds={0.1}>
        {isLoading ? (
          ...
          <SummaryCard
            title={locale === 'am' ? 'የትምህርት ስታቲስቲክስ' : 'Learning Statistics'}
            rows={[
              {
              ...
              {
                label: locale === 'am' ? 'በሂደት ላይ' : 'In progress',
        ...
        <Card>
          <CardHeader className="flex-row items-center justify-between space-y-0">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">
                {locale === 'am' ? 'ስኬቶች እና ሰርተፊኬቶች' : 'Achievements & Certificates'}
              </CardTitle>
            </div>
            {certificates.length > 0 && (
              <Button variant="ghost" size="sm" asChild>
                <Link href={ROUTES.dashboard.certificates}>
                  {locale === 'am' ? 'ሁሉንም አሳይ' : 'View all'}
                </Link>
              </Button>
            )}
          </CardHeader>
          ...
          <Card>
            <CardHeader className="flex-row items-center justify-between space-y-0">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-base">
                  {locale === 'am' ? 'የአሁኑ ኮርሶች' : 'Current Courses'}
                </CardTitle>
              </div>
              {inProgress.length > 0 && (
                <Button variant="ghost" size="sm" asChild>
          ...
          <Card>
            <CardHeader className="flex-row items-center justify-between space-y-0">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-base">{t('dashboard.completedCourses')}</CardTitle>
              </div>
              {completed.length > 0 && (
                <Button variant="ghost" size="sm" asChild>
                  <Link href={ROUTES.dashboard.courses}>
