      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[var(--sidebar-width)] bg-sidebar p-0 text-sidebar-foreground shadow-sidebar duration-300 data-[state=closed]:duration-300 data-[state=open]:duration-300 [&>button]:hidden"
            style={
              {
