...
const SIDEBAR_LABEL_MAP: Record<string, TranslationKey> = {
  ...
  // Admin Navigation Items & Groups
  MANAGEMENT: 'sidebar.admin',
  OPERATIONS: 'sidebar.admin',
  INSIGHTS: 'sidebar.reports',
  SYSTEM: 'sidebar.system',
  'User Management': 'sidebar.users',
  'Academic Management': 'sidebar.academics',
  'Financial Management': 'sidebar.financial',
  'Certificate Management': 'sidebar.certificates',
  'Verify Certificate': 'nav.verifyCertificate',
  Communication: 'sidebar.notifications',
  ...
  'Activity Logs': 'sidebar.reports',
  'Academy Settings': 'sidebar.system',
  'Profile & Security': 'sidebar.profile',
};
